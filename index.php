    ...
    <div class="user-page-container">
        <header class="user-topbar">
            ...
            <div class="app-mode-selector">
                <button class="mode-tab active" data-mode="mail">
                ...
                <button class="mode-tab" data-mode="twofa">
                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
        ...
        <main class="user-main">
            ...
            <!-- 2FA Mode Content -->
            <div id="twofaModeContent" class="hidden">
                <section class="compose-shell">
                    <div class="compose-row">
                        <div class="email-input-wrapper">
                            <input type="text" id="twofaInput" class="email-input"
                                placeholder="Nhập khóa bí mật 2FA (Secret Key), ví dụ: IBLP7SIULODDIWYRAX6NMB4LWS4X35PS" autocomplete="off"
                                spellcheck="false">
                            <button id="twofaClearBtn" class="btn-copy" title="Xóa khóa bí mật" style="display: none;">
                                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                    stroke-width="2">
                        ...
                        <button id="getOtpBtn" class="btn-get">
                ...
                <section id="twofaResultSection" class="inbox-section hidden">
                    <div class="inbox-header">
                        <div class="inbox-title">
                            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                stroke-width="2">
                    ...
                    <div class="twofa-card-body">
                        <div class="twofa-otp-display">
                            <div class="otp-code-wrapper" id="otpCodeWrapper" title="Nhấp để sao chép">
                                <span class="otp-digit-group" id="otpGroup1">---</span>
                                <span class="otp-digit-group" id="otpGroup2">---</span>
                            </div>
                            <button id="copyOtpBtn" class="btn-copy-otp-large">
                        ...
                        <div class="twofa-timer-wrapper">
                            <div class="twofa-progress-bar-bg">
                                <div class="twofa-progress-bar" id="twofaProgress"></div>
                            </div>
                            <span class="twofa-timer-text" id="twofaTimerText">Tự động cập nhật sau 30s</span>
                        </div>
                    </div>
                </section>
            </div>
